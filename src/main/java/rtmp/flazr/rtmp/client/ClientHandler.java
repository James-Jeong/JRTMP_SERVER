...
import rtmp.server.so.ClientSharedObject;
...
public class ClientHandler extends SimpleChannelUpstreamHandler {
    ...
    public ClientHandler(ClientOptions options) {
        ...
        transactionToCommandMap = new HashMap<>();
    }
...
//	    }		
	...
	protected void onCommandStatus(Channel channel, Command command, Map<String, Object> args) {
