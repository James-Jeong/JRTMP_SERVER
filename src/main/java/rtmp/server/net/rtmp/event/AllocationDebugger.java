package rtmp.server.net.rtmp.event;
...
public class AllocationDebugger {
	 ...
	 */
	private static rtmp.server.net.rtmp.event.AllocationDebugger instance = new rtmp.server.net.rtmp.event.AllocationDebugger();
	 ...
	 */
	public static rtmp.server.net.rtmp.event.AllocationDebugger getInstance() {
		return instance;
	}
