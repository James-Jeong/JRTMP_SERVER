...
import static rtmp.server.api.so.ISharedObject.TYPE;
...
public class SharedObject extends AttributeStore implements ISharedObjectStatistics, Constants {
	 ...
	 * Logger
	 */
	protected static Logger log = LoggerFactory.getLogger(rtmp.server.so.SharedObject.class);
