...
public class AllocationDebugger {
	 ...
	 */
	private static org.red5.server.net.rtmp.event.AllocationDebugger instance = new org.red5.server.net.rtmp.event.AllocationDebugger();
	 ...
	 */
	public static org.red5.server.net.rtmp.event.AllocationDebugger getInstance() {
		return instance;
	}
